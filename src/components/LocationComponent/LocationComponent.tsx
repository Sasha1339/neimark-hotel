...
const hotel = [
  {
    ...
    places: 'Первый корпус призван не только для проживания, но и встречать наших гостей, здесь будущие студенты смогут пройти необходимую регистрацию и получить рданные для входа во внутренние сервисы гостиницы кампуса Неймарк'
  },
  {
    id: 'Building2',
    number: 2,
    ...
    places: 'Для жителей второго корпуса открыватся буквально минутная возможность посетить на первом этаже одно из первых открывышихся мест в гостинице - вкуснейшая "Блинная", запах ароматных блинов не оставит равнодушными жителей корпуса "Харитон"'
  },
  {
    id: 'Building3',
    number: 3,
    ...
    places: 'Одна из самых популярных кофейн находится в нескольких этажах от жителей корпуса "Лобачевский", в Starbucks можно уютно отдохнуть за кружкой кофе'
  },
  {
    id: 'Building4',
    number: 4,
  ...
  },
  {
    ...
    places: '"Харитон" не оставит вас без возможности печатать, но не бумажных листов, а самых разных фигурок в 3д формате, которых вы только можете себе навоброозить!'
  },
  {
    id: 'Building11',
    number: 11,
  ...
  },
  {
    ...
    places: 'Зал единоборств, парикмахерская или книжный дом, все это прямо на певром этаже корпуса "Алексеев", уверены, вы сможете подобрать любимое занятие или попробовать все сразу!'
  },
  {
    id: 'Building14',
    number: 14,
