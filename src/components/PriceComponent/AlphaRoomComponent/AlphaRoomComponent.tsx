...
import styles from "./AlphaRoomComponent.module.css";
...
export const AlphaRoomComponent: FC<Props> = ({ onBack, ...props}) => {
  ...
  const getImageUrl = (index: number) => {
    switch (index) {
      ...
      case 1:
        return 'https://cdn.b12.io/client_media/VhBHooYp/83e7c91b-84b2-11f0-a66b-0242ac110002-IMG_9224.WEBP';
      case 2:
