...
const itemsNews = [
  {
    ...
    description: 'Мы рады сообщить, что в гостиницах Неймарк теперь доступны новые типы комнат, специально\n' +
      ...
      '                  идеальные условия для учебы и отдыха. Каждая комната оснащена всем необымым.',
    date: '21.03.2001',
    image: new1
  },
  {
  ...
  },
  {
    ...
    description: 'Гостиницы Неймарк запускают программу поддержки для студентов, предлагая консультации и помощь в различных аспектах их жизни. Мы понимаем, что учеба может быть сложной, и поэтому создаем условия, где студенты могут получить необходимую поддержку.',
    date: '07.07.2025',
    image: new3
  }
]
